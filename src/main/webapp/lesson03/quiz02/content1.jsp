...
<table class="table text-center">
	...
	<tbody>
		<tr>
			...
			<td class="col-4"><a href=http://localhost/lesson03/quiz03/layout.jsp?id=<%= music.get("id") %>><%= music.get("title") %></a></td>
			<td class="col-6"><%= music.get("album") %></td>
		</tr>
	</tbody>
</table>
<%
		} else if (id == music.get("id")) {
			target = music;
		}
	}
%>